...
#define LOGRADIO_DEPRECATED_UUID "6c6fd238-78fa-436b-aacf-15c5be1ef2e2"
#define LOGRADIO_UUID "6c6fd238-78fa-436b-aacf-15c5be1ef2e3"
...
class BluetoothApi
{
  public:
    ...
    virtual void sendLog(const uint8_t *bytes, size_t numBytes, bool useDeprecated = false) = 0;
};