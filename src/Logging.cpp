...
size_t Logging::vprintf(const char *logLevel, const char *format, va_list arg)
{
    va_list copy;
...
void Logging::log_to_serial(const char *logLevel, const char *format, va_list arg)
{
    size_t r = 0;
...
void Logging::log_to_syslog(const char *logLevel, const char *format, va_list arg)
{
...
void Logging::log_to_ble(const char *logLevel, const char *format, va_list arg)
{
#if HAS_BLUETOOTH
#ifdef ARCH_ESP32
...
void Logging::log(const char *logLevel, const char *format, ...)
{
#ifdef ARCH_PORTDUINO
...
void Logging::hexDump(const char *logLevel, unsigned char *buf, uint16_t len)
{
...
std::string Logging::mt_sprintf(const std::string fmt_str, ...)
{
